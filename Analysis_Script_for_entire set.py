# -*- coding: utf-8 -*-
"""
Created on Fri Dec  6 16:35:50 2019
...
os.getcwd()
os.chdir('C:\Fall2019\DAEN 690')

#connecting to postgres SQL
conn = psycopg2.connect(host="localhost",database="scicast", user="postgres", password="conceptsquad")
cursor = conn.cursor()
